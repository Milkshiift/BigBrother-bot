...
- As the logs are only appended to, data is never deleted or modified. All changes are new log entries.
...
| `a`  | u64    | Author ID                                   |
| `e`  | array  | Embeds (Twilight Discord Embed Structure)   |
...
| `i` | u64    | Sticker ID                                   |
| `n` | string | Name                                         |
| `f` | u8     | Format Type (1=PNG, 2=APNG, 3=LOTTIE, 4=GIF) |
| `d` | bool   | Deleted                                      |